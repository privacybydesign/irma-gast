  ...
  return (
    <div className="content" id="privacypolicy">
      ...
      <p>
        ...
        <a href="https://privacybydesign.foundation/">Privacy by Design</a> en
        het bedrijf <a href="https://www.procolix.com/">ProcoliX</a>. De
      ...
      <p>
        ...
        ProcoliX versleuteld opgeslagen. Het <em>tijdstip</em> van toevoeging
      ...
      <p>
        ...
        bezoeker wordt, samen met een publieke sleutel (<em>public key</em>,
        afgeleid van de e-mail van de host) teruggegeven aan de webpagina
        waarvan de bezoeker afkomstig is (via de genoemde knop). Het e-mailadres
        van de bezoeker wordt daarna direct verwijderd door de IRMA server bij
        de stichting. In het bijzonder houdt de stichting geen log bij van
        e-mailadressen van bezoekers.{" "}
      </p>
      ...
      <p>
        ...
        van alle hosts, maar niet van bezoekers (want die zijn versleuteld en
        onleesbaar voor ProcoliX). Voor de IRMA server van de stichting Privacy
        by Design is dit andersom: wel van bezoekers maar niet van hosts. De
        versleuteling is <em>identity-based</em>: uit het e-mailadres van de
        host wordt een <em>public key</em>
        afgeleid die gebruikt wordt voor de versleuteling van de gegevens voor
        de samenkomst(en) van de host. De versleuteling vindt plaats in de
        browser van de bezoeker (en niet bij ProcoliX).{" "}
      </p>
      ...
      <p>
        ...
        server levert de <em>private key</em> horend bij het e-mailadres van de
        host, waarmee de e-mailadressen in de webbrowser van de host ontsleuteld
      ...
      <p>
        ...
        partijen achter IRMA-welkom samenspannen en de gegevens combineren die
        zij voor IRMA-welkom apart bewerken. Deze partijen zullen niet zo
